      ...
      <div className="wrapper" id="aboutUs">
        ...
        <div className="features-wrapper">
          <div className="feature">
            ...
            <div className="feature-role">
              {" "}
              Only specific users can access the admin panel through their
              mobile number and password. The password cannot be changed once
              created, and it is securely hidden during input on the login
              screen.
            </div>
          </div>
          <div className="feature">
            ...
            <div className="feature-role">
              ...
              control, ensuring that only authorized personnel can use the app
          ...
          <div className="feature">
            ...
            <div className="feature-role">
              ...
              database, ensuring that all data is kept secure. Without logging
              into the admin panel, no user can access the database in any form.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="wrapper">
        ...
        <div className="team-wrapper">
          ...
          <div className="team-member">
            ...
            <div className="team-member-role">WORKED AS</div>
            <div className="team-member-role">AI-ML Engineer</div>
          </div>
          <div className="team-member">
          ...
          <div className="team-member">
            ...
            <div className="team-member-role">WORKED AS</div>
            <div className="team-member-role">App Developer</div>
          </div>
          <div className="team-member">
            <img
              src={Rudreshwar}
            ...
            <div className="contact-info">
              ...
              <div className="contact-details">
                ...
                <div className="contact-role">
                  <a
                    href="mailto: ekanshbhushan@gmail.com"
                    className="text-primary-11 font-bold "
                  >
                    ekanshbhushan@gmail.com
                  </a>
                </div>
